package application.view.TextUI;
...
public class AdminTextUI {
	...
	/*
	 * [quando cerco di modificare la sala non posso modificare nulla (posti...) perch� si ripresenta sempre lo stesso men�]
	 ...
	 * [manca tutto il men� opzioni quando cerco di modificare una proiezione]
	 */
