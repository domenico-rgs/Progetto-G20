...
CREATE TABLE AVAILABILITY
	...
	FOREIGN KEY (showingID) REFERENCES MOVIESHOWINGS(id) ON DELETE CASCADE);
...
CREATE TABLE TICKETS
	...
	FOREIGN KEY (showingID) REFERENCES MOVIESHOWINGS(id) ON DELETE SET NULL,
	FOREIGN KEY (occupiedSeat, theatre) REFERENCES AVAILABILITY(pos, theatre) ON DELETE NO ACTION);
